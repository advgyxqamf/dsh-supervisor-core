...
export const name = 'web-remote-polyfill';
...
export function apply(ctx, config) {
    // Always inject: the polyfill is a no-op where crypto.randomUUID exists
    // (loopback/HTTPS) and is REQUIRED on insecure LAN origins — which is the
    // whole point of direct remote access.
