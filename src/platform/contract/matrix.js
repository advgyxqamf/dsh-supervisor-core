...
//     · domains/dist/index.js       { darwin, win32, linux } → { darwin, win, linux }（步骤3 上移 platform/distribution）
//     · guard/supervisor/settings-view.js  { win32, linux, darwin } → { win, linux, darwin }
//     · domains/plugin/ops.js       process.platform !== 'win32'（进程组语义；原 plugins.js 已拆）
