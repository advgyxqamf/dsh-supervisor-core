...
// 平台能力：在线探测（原 guard/monitor/index.js，Phase 1 上游化——守卫与各域共用的纯探测，无生命周期动作）。
 ...
 *  - L2 HTTP 健康（httpOk）：GET healthUrl 2xx（或 401/403 认证响应视为在线；httpProbeEnabled=false 时退化为 up）；
