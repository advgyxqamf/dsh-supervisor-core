    ...
    return (
      <Card className="overflow-visible">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-t border-border/60 px-6 py-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Button disabled={!running} onClick={() => void act(it.id, () => supervisorApi.instanceOpenWeb(it.id))} size="sm" title="打开 DSH Web（自动带认证连接）" variant="outline">
            ...
            <Button className="h-[30px]" disabled={busy} onClick={() => setConfirmId(it.id)} size="sm" variant="destructive">
        ...
        <DialogContent className="max-w-[440px]">
          ...
          <div className="grid gap-3">
            ...
            <div className="grid gap-1.5">
              ...
              <textarea
                className="min-h-[72px] w-full rounded-md border border-input bg-transparent px-3 py-2 font-mono text-sm outline-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/20"
